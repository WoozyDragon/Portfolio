//aside from this line, this code file is unedited by me (Alex Repikov)
...
int RC_min[6] = { 1016,   1016,   1024,   1064,   1100,   988};
int RC_mid[6] = { 1500,   1500,   1500,   1504,   1500,   1512};
int RC_max[6] = { 1948,   1992,   1984,   1992,   1900,   2008};

// fail safe positions

float RC_failsafe[] = {0.00, 0.00, 0.00, 0.00, -1.00, 0.00};
